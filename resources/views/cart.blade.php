...
<table id="cart" class="table table-hover table-condensed container">
    ...
    <tbody>
      ...
      @if($total_price!=0)
            ...
            <tr>
                ...
                <td style="text-align:center">{{  $chrage->price }} VNĐ</td>
    ...
    <tfoot>
        ...
        @endphp
            ...
            <td colspan="5" class="text-right"><h5><strong>Total {{ $without_discount_price }} VNĐ</strong></h5></td>
        </tr>
        <tr>
  
            <td colspan="5" class="text-right"><h5><strong>Discount {{ $discount_price }} VNĐ</strong></h5></td>
        </tr>
        <tr>
      
            <td colspan="5" class="text-right"><h3><strong>Total (With Discount) {{ $total_price }} VNĐ</strong></h3></td>
        </tr>
        <tr>
