                    ...
                    <form class="forms-sample" action="{{ asset('/menu/edit/process/'.$product->id) }}" method="post" enctype="multipart/form-data" id="menuForm">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="session" id="menuSession">
                          <option value="0" @php if($product->session=="0"){ echo"selected"; }   @endphp>Combo 1-2 người</option>
                          <option value="1" @php if($product->session=="1"){ echo"selected"; }   @endphp>Combo 3-4 người</option>
                          <option value="2" @php if($product->session=="2"){ echo"selected"; }   @endphp>Combo 5-6 người</option>
                        </select>
                      </div>
