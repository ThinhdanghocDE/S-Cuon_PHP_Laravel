...
Route::post('/test-validation', function (Illuminate\Http\Request $request) {
    ...
    return back()->with('success', 'Validation thành công!');
});
...
Route::get('/mails/shipped/{total}', [ShipmentController::class, 'place_order'])->name('mails.shipped');
Route::post('/mails/shipped/{total}', [ShipmentController::class, 'place_order'])->name('mails.shipped.post');
...
Route::get('/terms-of-use', function () {
    return view('footer.terms-of-use');
})->name('terms-of-use');
...
Route::get('/recruitment', function () {
    return view('footer.recruitment');
})->name('recruitment');
